...
C     ----------
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV2_3_2(W(1,1),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,35))  !  count 8
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,36))  !  count 8
      CALL FFV2_3_2(W(1,2),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,37))  !  count 8
      CALL FFV2_3_2(W(1,2),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 8
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 8
      CALL FFV2_3_2(W(1,1),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 8
      CALL FFV2_3_2(W(1,2),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 8
      CALL FFV2_3_2(W(1,2),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,42))  !  count 8
