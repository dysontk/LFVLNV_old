...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 6
     ...
     $)  !  count 20
      CALL VXXXXX(P(0,7),ZERO,+1,+1*IC(7),W(1,17))  !  count 20
      CALL VXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,18))  !  count 20
      CALL FFV1_2(W(1,1),W(1,17),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 8
      CALL FFV1_2(W(1,1),W(1,18),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 8
      CALL FFV1_2(W(1,2),W(1,17),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 8
      CALL FFV1_2(W(1,2),W(1,18),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 8
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,3),W(1,17),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 8
      CALL FFV1_1(W(1,3),W(1,18),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 8
      CALL FFV1_1(W(1,4),W(1,17),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 8
      CALL FFV1_1(W(1,4),W(1,18),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 8
      CALL FFV2_5_2(W(1,1),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,35))  !  count 8
      CALL FFV2_5_2(W(1,1),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,36))  !  count 8
      CALL FFV2_5_2(W(1,2),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,37))  !  count 8
      CALL FFV2_5_2(W(1,2),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 8
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_2(W(1,1),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 8
      CALL FFV2_5_2(W(1,1),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 8
      CALL FFV2_5_2(W(1,2),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 8
      CALL FFV2_5_2(W(1,2),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,42))  !  count 8
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1P1N_1(W(1,29), W(1,17), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/35,36/),
     & TMP, W, AMP(1,5))
      CALL FFV1P1N_1(W(1,29), W(1,18), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/35,36/),
     & TMP, W, AMP(1,5))
      CALL FFV1P1N_1(W(1,30), W(1,17), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/35,36/),
     & TMP, W, AMP(1,5))
      CALL FFV1P1N_1(W(1,30), W(1,18), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/35,36/),
     & TMP, W, AMP(1,5))
     ...
     & (/39,40/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_1(W(1,23), W(1,17), GC_11, TMP(1))
      call CombineAmp(2,
     & (/10,12/), 
     & (/41,42/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_1(W(1,23), W(1,18), GC_11, TMP(1))
      call CombineAmp(2,
     & (/9,11/), 
     & (/41,42/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_1(W(1,24), W(1,17), GC_11, TMP(1))
      call CombineAmp(2,
     & (/14,16/), 
     & (/41,42/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_1(W(1,24), W(1,18), GC_11, TMP(1))
      call CombineAmp(2,
     & (/13,15/), 
     & (/41,42/),
