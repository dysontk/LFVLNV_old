...
C     ----------
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,57))  !  count 6
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,58))  !  count 6
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,59))  !  count 6
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,60))  !  count 6
      CALL FFV1_2(W(1,19),W(1,17),GC_11,ZERO,FK_ZERO,W(1,61))  !  count 34
      CALL FFV1_2(W(1,19),W(1,18),GC_11,ZERO,FK_ZERO,W(1,62))  !  count 34
      CALL FFV1_2(W(1,20),W(1,17),GC_11,ZERO,FK_ZERO,W(1,63))  !  count 34
      CALL FFV1_2(W(1,20),W(1,18),GC_11,ZERO,FK_ZERO,W(1,64))  !  count 34
     ...
     & TMP, W, AMP(1,12))  !  count 1
      ...
      CALL FFV1_1(W(1,3),W(1,17),GC_11,ZERO,FK_ZERO,W(1,93))  !  count 34
      CALL FFV1_1(W(1,3),W(1,18),GC_11,ZERO,FK_ZERO,W(1,94))  !  count 34
      CALL FFV1_1(W(1,4),W(1,17),GC_11,ZERO,FK_ZERO,W(1,95))  !  count 34
      CALL FFV1_1(W(1,4),W(1,18),GC_11,ZERO,FK_ZERO,W(1,96))  !  count 34
