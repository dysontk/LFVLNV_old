...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,4))  !  count 6
     ...
     $)  !  count 20
      CALL OXXXXX(P(0,7),ZERO,+1,+1*IC(7),W(1,17))  !  count 6
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,18))  !  count 6
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 8
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 8
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 8
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 8
      CALL FFV2_5_1(W(1,17),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,23))  !  count 8
      CALL FFV2_5_1(W(1,17),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 8
      CALL FFV2_5_1(W(1,18),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 8
      CALL FFV2_5_1(W(1,18),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_1(W(1,17),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 8
      CALL FFV2_5_1(W(1,17),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 8
      CALL FFV2_5_1(W(1,18),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,29))  !  count 8
      CALL FFV2_5_1(W(1,18),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 8
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,17),W(1,1),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 8
      CALL FFV1_1(W(1,17),W(1,2),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 8
      CALL FFV1_1(W(1,18),W(1,1),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 8
      CALL FFV1_1(W(1,18),W(1,2),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 8
      CALL FFV2_5_2(W(1,3),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,35))  !  count 8
      CALL FFV2_5_2(W(1,3),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,36))  !  count 8
      CALL FFV2_5_2(W(1,4),W(1,9),-GC_50,GC_58,ZERO,FK_ZERO,W(1,37))  !  count 8
      CALL FFV2_5_2(W(1,4),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 8
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_2(W(1,3),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 8
      CALL FFV2_5_2(W(1,3),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 8
      CALL FFV2_5_2(W(1,4),W(1,15),-GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 8
      CALL FFV2_5_2(W(1,4),W(1,16),-GC_50,GC_58,ZERO,FK_ZERO,W(1,42))  !  count 8
