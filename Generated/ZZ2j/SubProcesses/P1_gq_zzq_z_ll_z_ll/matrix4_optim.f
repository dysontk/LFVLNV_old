...
C     ----------
     ...
     $)  !  count 20
      ...
      CALL FFV2_3_1(W(1,17),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,23))  !  count 8
      CALL FFV2_3_1(W(1,17),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 8
      CALL FFV2_3_1(W(1,18),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 8
      CALL FFV2_3_1(W(1,18),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 8
      CALL FFV2_3P1N_1(W(1,23), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/9,1/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV2_3P1N_1(W(1,23), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/10,2/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV2_3P1N_1(W(1,24), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/11,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV2_3P1N_1(W(1,24), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/12,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_1(W(1,17),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 8
      CALL FFV2_3_1(W(1,17),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 8
      CALL FFV2_3_1(W(1,18),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,29))  !  count 8
      CALL FFV2_3_1(W(1,18),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 8
      CALL FFV2_3P1N_1(W(1,27), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/9,1/), 
     & (/19,20/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,27), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/11,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,28), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/10,2/), 
     & (/19,20/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,28), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/12,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,29), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/13,5/), 
     & (/21,22/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,29), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/15,7/), 
     & (/21,22/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,30), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/14,6/), 
     & (/21,22/),
     & TMP, W, AMP(1,2))
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV2_3_2(W(1,3),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,35))  !  count 8
      CALL FFV2_3_2(W(1,3),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,36))  !  count 8
      CALL FFV2_3_2(W(1,4),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,37))  !  count 8
      CALL FFV2_3_2(W(1,4),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 8
      CALL FFV2_3P1N_1(W(1,31), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/9,11/), 
     & (/35,36/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,31), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/10,12/), 
     & (/35,36/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,32), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/35,36/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,32), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/35,36/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,33), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/13,15/), 
     & (/37,38/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,33), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/14,16/), 
     & (/37,38/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,34), W(1,15), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/37,38/),
     & TMP, W, AMP(1,3))
      CALL FFV2_3P1N_1(W(1,34), W(1,16), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/37,38/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_2(W(1,3),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 8
      CALL FFV2_3_2(W(1,3),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 8
      CALL FFV2_3_2(W(1,4),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 8
      CALL FFV2_3_2(W(1,4),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,42))  !  count 8
      CALL FFV2_3P1N_1(W(1,31), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/9,10/), 
     & (/39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,31), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/11,12/), 
     & (/39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,32), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,32), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,33), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/41,42/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,33), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/41,42/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,34), W(1,9), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/41,42/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_1(W(1,34), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/41,42/),
