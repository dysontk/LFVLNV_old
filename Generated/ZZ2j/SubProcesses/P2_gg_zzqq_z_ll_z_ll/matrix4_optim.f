...
C     ----------
     ...
     $)  !  count 172
      ...
      CALL FFV2_3_1(W(1,17),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 50
      CALL FFV2_3_1(W(1,17),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 50
      CALL FFV2_3_1(W(1,18),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 50
      CALL FFV2_3_1(W(1,18),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 50
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_2(W(1,19),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,37))  !  count 50
      CALL FFV2_3_2(W(1,19),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 50
      CALL FFV2_3_2(W(1,20),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 50
      CALL FFV2_3_2(W(1,20),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 50
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_2(W(1,19),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 50
      CALL FFV2_3_2(W(1,19),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,42))  !  count 50
      CALL FFV2_3_2(W(1,20),W(1,9),GC_50,GC_58,ZERO,FK_ZERO,W(1,43))  !  count 50
      CALL FFV2_3_2(W(1,20),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,44))  !  count 50
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_1(W(1,17),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,53))  !  count 50
      CALL FFV2_3_1(W(1,17),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,54))  !  count 50
      CALL FFV2_3_1(W(1,18),W(1,15),GC_50,GC_58,ZERO,FK_ZERO,W(1,55))  !  count 50
      CALL FFV2_3_1(W(1,18),W(1,16),GC_50,GC_58,ZERO,FK_ZERO,W(1,56))  !  count 50
