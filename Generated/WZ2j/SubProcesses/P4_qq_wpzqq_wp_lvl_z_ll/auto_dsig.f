...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > e+ ve e+ e- u d
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u > e+ ve mu+ mu- u d
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u c > e+ ve e+ e- u s
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u c > e+ ve mu+ mu- u s
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u c > e+ ve e+ e- c d
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u c > e+ ve mu+ mu- c d
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u d > e+ ve e+ e- d d
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u d > e+ ve mu+ mu- d d
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u s > e+ ve e+ e- d s
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u s > e+ ve mu+ mu- d s
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u u~ > e+ ve e+ e- d u~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u u~ > e+ ve mu+ mu- d u~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u u~ > e+ ve e+ e- s c~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u u~ > e+ ve mu+ mu- s c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u c~ > e+ ve e+ e- d c~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u c~ > e+ ve mu+ mu- d c~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u d~ > e+ ve e+ e- u u~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u d~ > e+ ve mu+ mu- u u~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u d~ > e+ ve e+ e- c c~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! u d~ > e+ ve mu+ mu- c c~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! u d~ > e+ ve e+ e- d d~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! u d~ > e+ ve mu+ mu- d d~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! u d~ > e+ ve e+ e- s s~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! u d~ > e+ ve mu+ mu- s s~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! u s~ > e+ ve e+ e- u c~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! u s~ > e+ ve mu+ mu- u c~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! u s~ > e+ ve e+ e- d s~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! u s~ > e+ ve mu+ mu- d s~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! d d~ > e+ ve e+ e- d u~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! d d~ > e+ ve mu+ mu- d u~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! d d~ > e+ ve e+ e- s c~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! d d~ > e+ ve mu+ mu- s c~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! d s~ > e+ ve e+ e- d c~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d s~ > e+ ve mu+ mu- d c~
        IF(IPROC.EQ.35) DSIGPROC=DSIG35(P1,WGT,IMODE)  ! u~ d~ > e+ ve e+ e- u~ u~
        IF(IPROC.EQ.36) DSIGPROC=DSIG36(P1,WGT,IMODE)  ! u~ d~ > e+ ve mu+ mu- u~ u~
        IF(IPROC.EQ.37) DSIGPROC=DSIG37(P1,WGT,IMODE)  ! u~ s~ > e+ ve e+ e- u~ c~
        IF(IPROC.EQ.38) DSIGPROC=DSIG38(P1,WGT,IMODE)  ! u~ s~ > e+ ve mu+ mu- u~ c~
        IF(IPROC.EQ.39) DSIGPROC=DSIG39(P1,WGT,IMODE)  ! d~ d~ > e+ ve e+ e- u~ d~
        IF(IPROC.EQ.40) DSIGPROC=DSIG40(P1,WGT,IMODE)  ! d~ d~ > e+ ve mu+ mu- u~ d~
        IF(IPROC.EQ.41) DSIGPROC=DSIG41(P1,WGT,IMODE)  ! d~ s~ > e+ ve e+ e- u~ s~
        IF(IPROC.EQ.42) DSIGPROC=DSIG42(P1,WGT,IMODE)  ! d~ s~ > e+ ve mu+ mu- u~ s~
        IF(IPROC.EQ.43) DSIGPROC=DSIG43(P1,WGT,IMODE)  ! d~ s~ > e+ ve e+ e- c~ d~
        IF(IPROC.EQ.44) DSIGPROC=DSIG44(P1,WGT,IMODE)  ! d~ s~ > e+ ve mu+ mu- c~ d~
      ENDIF
