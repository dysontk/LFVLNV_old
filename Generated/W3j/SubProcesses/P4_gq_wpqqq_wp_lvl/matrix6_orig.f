...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,7),W(1,4),W(1,12),GC_11,AMP(5))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,11),W(1,4),W(1,13),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,4),W(1,13),GC_11,AMP(13))
      CALL FFV2_2(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,13),W(1,4),W(1,10),GC_11,AMP(17))
