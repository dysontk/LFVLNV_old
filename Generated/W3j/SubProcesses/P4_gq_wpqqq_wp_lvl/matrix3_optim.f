...
C     
C     Process: g u > w+ c d c~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g u > w+ s d s~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g c > w+ u s u~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g c > w+ d s d~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,7))  !  count 5
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 5
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,9))  !  count 23
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,10))  !  count 5
      CALL IXXXXX(P(0,7),ZERO,-1,-1*IC(7),W(1,11))  !  count 5
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 3
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 3
      CALL FFV2_1(W(1,9),W(1,6),GC_100,ZERO,FK_ZERO,W(1,14))  !  count 18
      CALL FFV1P0_3(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 14
      CALL FFV1P0_3(W(1,11),W(1,7),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 14
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,7),W(1,1),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 1
      CALL FFV1_1(W(1,7),W(1,2),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 1
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV2_2(W(1,3),W(1,6),GC_100,ZERO,FK_ZERO,W(1,23))  !  count 18
      CALL FFV1P0_3(W(1,10),W(1,21),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,22),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,19),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,20),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P1N_3(W(1,3), W(1,14), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,9),W(1,1),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 3
      CALL FFV1_1(W(1,9),W(1,2),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 3
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV1P1N_2(W(1,3), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,3), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,10),W(1,1),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 1
      CALL FFV1_2(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 1
      CALL FFV1_2(W(1,11),W(1,1),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 1
      CALL FFV1_2(W(1,11),W(1,2),GC_11,ZERO,FK_ZERO,W(1,35))  !  count 1
      CALL FFV1P0_3(W(1,32),W(1,8),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 2
      CALL FFV1P0_3(W(1,33),W(1,8),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV1P0_3(W(1,34),W(1,7),GC_11,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV1P0_3(W(1,35),W(1,7),GC_11,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/36,37,38,39/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV1_2(W(1,23),W(1,1),GC_11,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL FFV1_2(W(1,23),W(1,2),GC_11,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL FFV1P1N_1(W(1,9), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/40,41/),
     ...
     & TMP, W, AMP(1,9))  !  count 1
      CALL VVV1P0_1(W(1,1),W(1,15),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,1),W(1,16),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,15),GC_10,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,16),GC_10,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV1_1(W(1,14),W(1,1),GC_11,ZERO,FK_ZERO,W(1,46))  !  count 2
      CALL FFV1_1(W(1,14),W(1,2),GC_11,ZERO,FK_ZERO,W(1,47))  !  count 2
      CALL FFV1P1N_2(W(1,3), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/46,47/),
