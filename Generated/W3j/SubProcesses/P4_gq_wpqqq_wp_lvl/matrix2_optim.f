...
C     
C     Process: g u > w+ u s c~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g c > w+ c d u~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g d > w+ d s c~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: g s > w+ s d u~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,5),W(1,6),GC_100,MDL_MW,FK_MDL_WW,W(1,7))  !  count 6
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00000D+00,-5.000000000000000D-01))*TMP_JAMP(3)+( -5.000000000000000D-01)
     $  *TMP_JAMP(7)
        JAMP(3,1) = (-5.000000000000000D-01)*TMP_JAMP(2) +((0.0000000000
     $  00000D+00,5.000000000000000D-01))*TMP_JAMP(3)+( -5.000000000000000D-01)*
     $  TMP_JAMP(6)
        JAMP(4,1) = (1.666666666666667D-01)*TMP_JAMP(6) +(1.666666666666
     $  667D-01)*TMP_JAMP(7)
