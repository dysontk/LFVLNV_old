...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,6),W(1,4),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,2),W(1,9),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,7),W(1,10),W(1,5),GC_100,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,10),W(1,9),GC_11,AMP(10))
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,14))
      CALL FFV1_1(W(1,6),W(1,9),GC_11,ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,17),W(1,6),W(1,16),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,2),W(1,8),W(1,10),GC_11,AMP(49))
      CALL FFV1_0(W(1,2),W(1,8),W(1,17),GC_11,AMP(50))
      CALL FFV1_0(W(1,2),W(1,8),W(1,13),GC_11,AMP(51))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,12),W(1,6),W(1,10),GC_11,AMP(52))
      CALL FFV1_0(W(1,12),W(1,6),W(1,17),GC_11,AMP(53))
      CALL FFV1_0(W(1,12),W(1,6),W(1,13),GC_11,AMP(54))
