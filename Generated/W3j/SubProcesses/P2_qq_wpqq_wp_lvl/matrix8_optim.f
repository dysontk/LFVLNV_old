...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 2
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,9))  !  count 5
      CALL IXXXXX(P(0,6),ZERO,-1,-1*IC(6),W(1,10))  !  count 3
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,11))  !  count 1
      CALL FFV2_2(W(1,2),W(1,6),GC_100,ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1P0_3(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 2
      CALL FFV1P0_3(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 2
      CALL FFV1_0(W(1,11),W(1,3),W(1,13),GC_11,AMP(1,1))
      CALL FFV1P1N_3(W(1,12), W(1,3), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,3/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,7),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,7),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_2(W(1,9),W(1,6),GC_100,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_2(W(1,10),W(1,6),GC_100,ZERO,FK_ZERO,W(1,20))  !  count 1
      CALL FFV1P1N_3(W(1,19), W(1,3), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/16,18/),
     & TMP, W, AMP(1,2))
      CALL FFV1_0(W(1,20),W(1,3),W(1,17),GC_11,AMP(3,2))  !  count 1
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,FK_ZERO,W(1,21))  !  count 6
      CALL FFV1P1N_3(W(1,9), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/16,18/),
     & TMP, W, AMP(1,3))
      CALL FFV1_0(W(1,10),W(1,21),W(1,17),GC_11,AMP(3,3))  !  count 1
      CALL FFV1_0(W(1,1),W(1,21),W(1,13),GC_11,AMP(1,4))
