...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO, FK_ZERO,W(1,6))
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,4),W(1,6),GC_11,AMP(1))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,8),W(1,6),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,2),W(1,8),GC_11,AMP(3))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,7),W(1,8),GC_11,AMP(4))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(2)
