...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW,FK_MDL_WW,W(1,5))  !  count 2
      ...
      CALL FFV1P0_3(W(1,8),W(1,7),GC_11,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1P0_3(W(1,9),W(1,6),GC_11,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1P1N_3(W(1,12), W(1,2), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/10,11/),
