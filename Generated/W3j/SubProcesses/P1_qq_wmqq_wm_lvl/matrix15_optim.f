...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1P0_3(W(1,8),W(1,3),GC_11,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL FFV2_2(W(1,9),W(1,6),GC_100,ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1P1N_3(W(1,12), W(1,1), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_1(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,13))  !  count 2
