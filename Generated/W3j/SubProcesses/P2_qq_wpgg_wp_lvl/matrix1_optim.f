...
C     
C     Process: u d~ > w+ g g WEIGHTED<=4 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: c s~ > w+ g g WEIGHTED<=4 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,6))  !  count 8
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,7))  !  count 8
      CALL VXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,8))  !  count 8
      CALL VXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,9))  !  count 8
      CALL VVV1P0_1(W(1,6),W(1,8),GC_10,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL VVV1P0_1(W(1,6),W(1,9),GC_10,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL VVV1P0_1(W(1,7),W(1,8),GC_10,ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL VVV1P0_1(W(1,7),W(1,9),GC_10,ZERO,FK_ZERO,W(1,13))  !  count 2
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,FK_ZERO,W(1,14))  !  count 12
      CALL FFV1P1N_3(W(1,1), W(1,14), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,3,2,1/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,15))  !  count 12
      CALL FFV1P1N_3(W(1,15), W(1,2), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,3,2,1/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,2),W(1,6),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 4
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV2P1N_1(W(1,16), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/18,19/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_1(W(1,17), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/18,19/),
     ...
     & (/16,17/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,15), W(1,9), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/16,17/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_2(W(1,1),W(1,6),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 4
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 4
      CALL FFV1_1(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 4
      CALL FFV1_1(W(1,2),W(1,9),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 4
      CALL FFV2P1N_1(W(1,22), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/20,21/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_1(W(1,23), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/20,21/),
     ...
     & (/20,21/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_1(W(1,14), W(1,9), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/20,21/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P1N_2(W(1,15), W(1,6), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/22,23/),
     & TMP, W, AMP(1,7))
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV1P1N_1(W(1,14), W(1,6), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/18,19/),
     & TMP, W, AMP(1,8))
