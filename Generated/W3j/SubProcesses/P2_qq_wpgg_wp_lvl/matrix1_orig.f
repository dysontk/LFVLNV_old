...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL VVV1P0_1(W(1,4),W(1,3),GC_10,ZERO, FK_ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_2(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,9),W(1,6),W(1,5),GC_100,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,6),W(1,3),GC_11,AMP(4))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,6),W(1,1),W(1,5),GC_100,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,7),W(1,3),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,1),W(1,4),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,9),W(1,7),W(1,4),GC_11,AMP(8))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(1) +  AMP(2)  ! used 2 times
      JAMP(1,1) = AMP(3)+AMP(4)+AMP(8)+((0.000000000000000D+00,
     $ -1.000000000000000D+00))*TMP_JAMP(1)
      JAMP(2,1) = AMP(5)+AMP(6)+AMP(7)+((0.000000000000000D+00
     $ ,1.000000000000000D+00))*TMP_JAMP(1)
