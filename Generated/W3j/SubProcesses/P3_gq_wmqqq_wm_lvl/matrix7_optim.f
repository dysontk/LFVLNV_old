...
C     
C     Process: g u~ > w- c u~ s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g c~ > w- u c~ d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g d~ > w- c d~ s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g s~ > w- u s~ d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 23
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,9))  !  count 5
      CALL IXXXXX(P(0,6),ZERO,-1,-1*IC(6),W(1,10))  !  count 5
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,11))  !  count 23
      CALL FFV1_2(W(1,9),W(1,1),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_2(W(1,9),W(1,2),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_2(W(1,10),W(1,1),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_2(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV2_1(W(1,8),W(1,7),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 18
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,13),W(1,3),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P0_3(W(1,14),W(1,4),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV1P0_3(W(1,15),W(1,4),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,21), W(1,8), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,2,3,1/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 1
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 1
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 1
      CALL FFV1P0_3(W(1,9),W(1,22),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,9),W(1,23),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,24),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,25),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,2,3,1/), 
     & (/26,27,28,29/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 3
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 3
      CALL FFV1P0_3(W(1,9),W(1,3),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 14
      CALL FFV1P0_3(W(1,10),W(1,4),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 14
     ...
     & TMP, W, AMP(1,6))  !  count 1
      ...
      CALL FFV1P1N_1(W(1,8), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/38,39/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,8), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/38,39/),
