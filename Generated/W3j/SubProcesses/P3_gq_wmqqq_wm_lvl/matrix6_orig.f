...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,4),W(1,12),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,12),W(1,4),W(1,9),GC_11,AMP(13))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,4),W(1,13),GC_11,AMP(19))
      CALL FFV1_2(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,13),W(1,4),W(1,9),GC_11,AMP(20))
      CALL VVV1P0_1(W(1,1),W(1,11),GC_10,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,6),W(1,8),W(1,9),GC_11,AMP(21))
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,4),W(1,11),GC_11,AMP(22))
