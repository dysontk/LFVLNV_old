...
C     
C     Process: g u~ > w- c c~ d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g u~ > w- s s~ d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g c~ > w- u u~ s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g c~ > w- d d~ s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV1P0_3(W(1,14),W(1,7),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV1P0_3(W(1,15),W(1,7),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 2
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 3
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 3
      CALL FFV1P0_3(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 14
      CALL FFV1P0_3(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 14
      CALL FFV2_1(W(1,22),W(1,6),GC_100,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_1(W(1,23),W(1,6),GC_100,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P1N_2(W(1,11), W(1,24), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/26,27/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,11), W(1,25), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/26,27/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,7),W(1,1),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 1
      CALL FFV1_1(W(1,7),W(1,2),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 1
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 1
      CALL FFV1P0_3(W(1,9),W(1,30),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 2
      CALL FFV1P0_3(W(1,9),W(1,31),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,28),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,29),GC_11,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  TMP_JAMP(6)
        JAMP(2,1) = (1.666666666666667D-01)*TMP_JAMP(6) +(1.666666666666
     $  667D-01)*TMP_JAMP(7)
