...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,2),W(1,11),W(1,10),GC_11,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,9),W(1,10),GC_11,AMP(4))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1P0_3(W(1,6),W(1,9),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,8),W(1,3),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,4),W(1,3),GC_11,AMP(6))
      CALL FFV1_2(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,3))
      CALL FFV2_2(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,9),W(1,4),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,3),W(1,8),W(1,10),GC_11,AMP(8))
      CALL VVV1P0_1(W(1,1),W(1,10),GC_10,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,8),W(1,3),GC_11,AMP(9))
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,9),W(1,10),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,4),W(1,3),GC_11,AMP(11))
      CALL FFV1_2(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,3),W(1,4),W(1,10),GC_11,AMP(12))
