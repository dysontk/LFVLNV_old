...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,13),W(1,10),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1P0_3(W(1,2),W(1,13),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,8),W(1,14),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,2),W(1,8),W(1,9),GC_11,AMP(11))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,3),W(1,4),W(1,12),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,14),W(1,8),W(1,12),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,8),W(1,9),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,2),W(1,14),W(1,10),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,8),W(1,9),GC_11,AMP(24))
