...
C     
C     Process: g u > w- u c s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g c > w- c u d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g d > w- d c s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g s > w- s u d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     
      ...
      PARAMETER (NWAVEFUNCS=47, NCOLOR=4) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1))  !  count 10
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2))  !  count 10
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3))  !  count 5
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,4))  !  count 5
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,5))  !  count 1
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,6))  !  count 1
      CALL FFV2_3(W(1,6),W(1,5),GC_100,MDL_MW,FK_MDL_WW,W(1,7))  !  count 6
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,8))  !  count 5
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,9))  !  count 5
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,10))  !  count 23
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,11))  !  count 23
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV2_1(W(1,10),W(1,7),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 18
      CALL FFV1P0_3(W(1,12),W(1,8),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_2(W(1,11),W(1,7),GC_100,ZERO,FK_ZERO,W(1,21))  !  count 18
      CALL FFV1P1N_3(W(1,21), W(1,10), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 1
      CALL FFV1_1(W(1,9),W(1,1),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 1
      CALL FFV1_1(W(1,9),W(1,2),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 1
      CALL FFV1P0_3(W(1,3),W(1,22),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,23),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,24),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,25),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/26,27,28,29/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,10),W(1,1),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 3
      CALL FFV1_1(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 3
      CALL FFV1P0_3(W(1,3),W(1,8),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 14
      CALL FFV1P0_3(W(1,4),W(1,9),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 14
      CALL FFV2_1(W(1,30),W(1,7),GC_100,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2_1(W(1,31),W(1,7),GC_100,ZERO,FK_ZERO,W(1,35))  !  count 2
     ...
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV1P1N_2(W(1,21), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,21), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,11),W(1,1),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 3
      CALL FFV1_2(W(1,11),W(1,2),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 3
      CALL FFV2_2(W(1,36),W(1,7),GC_100,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV2_2(W(1,37),W(1,7),GC_100,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_1(W(1,10), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/38,39/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,10), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/38,39/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV1P1N_1(W(1,16), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/36,37/),
     & TMP, W, AMP(1,8))
      CALL FFV1P1N_1(W(1,16), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/36,37/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL VVV1P0_1(W(1,1),W(1,32),GC_10,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL VVV1P0_1(W(1,1),W(1,33),GC_10,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,32),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,33),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/40,41,42,43/),
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV1_1(W(1,16),W(1,1),GC_11,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL FFV1_1(W(1,16),W(1,2),GC_11,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_2(W(1,11), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/44,45/),
     ...
     & TMP, W, AMP(1,11))  !  count 1
      CALL FFV1_2(W(1,21),W(1,1),GC_11,ZERO,FK_ZERO,W(1,46))  !  count 2
      CALL FFV1_2(W(1,21),W(1,2),GC_11,ZERO,FK_ZERO,W(1,47))  !  count 2
      CALL FFV1P1N_1(W(1,10), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/46,47/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        TMP_JAMP(5) = AMP( K,7) +  AMP( K,8)   !  used 2 times
        TMP_JAMP(4) = AMP( K,5) +  AMP( K,6)   !  used 2 times
        TMP_JAMP(3) = AMP( K,9) +  AMP( K,11)   !  used 2 times
        TMP_JAMP(2) = AMP( K,1) +  AMP( K,2)   !  used 2 times
        TMP_JAMP(1) = AMP( K,3) +  AMP( K,4)   !  used 2 times
        TMP_JAMP(7) = TMP_JAMP(5) +  AMP( K,12)   !  used 2 times
        TMP_JAMP(6) = TMP_JAMP(4) +  AMP( K,10)   !  used 2 times
        JAMP(1,1) = (-1.666666666666667D-01)*TMP_JAMP(1)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(2)
        JAMP(2,1) = (5.000000000000000D-01)*TMP_JAMP(1) +((0.00000000000
     $  0000D+00,5.000000000000000D-01))*TMP_JAMP(3) +(5.000000000000000D-01)*TM
     $  P_JAMP(7)
        JAMP(3,1) = (5.000000000000000D-01)*TMP_JAMP(2) +((0.00000000000
     $  0000D+00,-5.000000000000000D-01))*TMP_JAMP(3) +(5.000000000000000D-01)*T
     $  MP_JAMP(6)
        JAMP(4,1) = (-1.666666666666667D-01)*TMP_JAMP(6)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(7)
