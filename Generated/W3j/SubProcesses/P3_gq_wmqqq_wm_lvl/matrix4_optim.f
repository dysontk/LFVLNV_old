...
C     
C     Process: g d > w- u c c~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g d > w- u s s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g s > w- c u u~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: g s > w- c d d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,7))  !  count 23
      ...
      CALL FFV1_2(W(1,10),W(1,1),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_2(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_2(W(1,11),W(1,1),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_2(W(1,11),W(1,2),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV2_1(W(1,7),W(1,6),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 18
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV1P1N_3(W(1,21), W(1,7), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,7),W(1,1),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 3
      CALL FFV1_1(W(1,7),W(1,2),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 3
      CALL FFV1P0_3(W(1,10),W(1,9),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 14
      CALL FFV1P0_3(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 14
      CALL FFV2_1(W(1,22),W(1,6),GC_100,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV2_1(W(1,23),W(1,6),GC_100,ZERO,FK_ZERO,W(1,27))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P1N_2(W(1,21), W(1,24), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/22,23/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,21), W(1,25), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/22,23/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 1
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 1
      CALL FFV1_1(W(1,9),W(1,1),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 1
      CALL FFV1_1(W(1,9),W(1,2),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 1
      CALL FFV1P0_3(W(1,10),W(1,30),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,31),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,28),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,29),GC_11,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/32,33,34,35/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 3
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 3
      CALL FFV2_2(W(1,36),W(1,6),GC_100,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV2_2(W(1,37),W(1,6),GC_100,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_1(W(1,7), W(1,24), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/38,39/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,7), W(1,25), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/38,39/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL VVV1P0_1(W(1,1),W(1,24),GC_10,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL VVV1P0_1(W(1,1),W(1,25),GC_10,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,24),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,25),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/40,41,42,43/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        TMP_JAMP(5) = AMP( K,5) +  AMP( K,6)   !  used 2 times
        ...
        TMP_JAMP(7) = TMP_JAMP(2) +  AMP( K,12)   !  used 2 times
     ...
     $  P_JAMP(3)+(5.000000000000000D-01)*TMP_JAMP(4) +(5.000000000000000D-01)*T
     $  MP_JAMP(6)
        JAMP(3,1) = ((0.000000000000000D+00,5.000000000000000D-01)) *TMP
     $  _JAMP(3)+(5.000000000000000D-01)*TMP_JAMP(5) +(5.000000000000000D-01)*TM
     $  P_JAMP(7)
