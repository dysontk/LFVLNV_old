...
C     
C     Process: u c > w+ g c d WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: u s > w+ g s d WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: c d > w+ g d s WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,1))  !  count 23
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,2))  !  count 5
      ...
      CALL FFV2_3(W(1,4),W(1,5),GC_100,MDL_MW,FK_MDL_WW,W(1,6))  !  count 6
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,7))  !  count 10
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 10
      CALL OXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,9))  !  count 5
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,10))  !  count 5
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,11))  !  count 23
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 3
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 3
      CALL FFV2_1(W(1,11),W(1,6),GC_100,ZERO,FK_ZERO,W(1,14))  !  count 18
      CALL FFV1P0_3(W(1,2),W(1,9),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 14
      CALL FFV1P0_3(W(1,3),W(1,10),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 14
      CALL FFV1P1N_1(W(1,14), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_2(W(1,12),W(1,6),GC_100,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV2_2(W(1,13),W(1,6),GC_100,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P1N_1(W(1,11), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/17,18/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/17,18/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 1
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 1
      CALL FFV1_1(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 1
      CALL FFV1_1(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,23))  !  count 18
      CALL FFV1P0_3(W(1,2),W(1,19),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,20),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,21),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,22),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,11), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P1N_3(W(1,1), W(1,14), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,11),W(1,7),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 3
      CALL FFV1_1(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 3
      CALL FFV1P1N_2(W(1,23), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/28,29/),
     & TMP, W, AMP(1,5))
      CALL FFV1P1N_2(W(1,23), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/28,29/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV2_1(W(1,28),W(1,6),GC_100,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV2_1(W(1,29),W(1,6),GC_100,ZERO,FK_ZERO,W(1,31))  !  count 2
      CALL FFV1P1N_2(W(1,1), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,1), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/30,31/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,2),W(1,7),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 1
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 1
      CALL FFV1_2(W(1,3),W(1,7),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 1
      CALL FFV1_2(W(1,3),W(1,8),GC_11,ZERO,FK_ZERO,W(1,35))  !  count 1
      CALL FFV1P0_3(W(1,32),W(1,9),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 2
      CALL FFV1P0_3(W(1,33),W(1,9),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV1P0_3(W(1,34),W(1,10),GC_11,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV1P0_3(W(1,35),W(1,10),GC_11,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,11), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/36,37,38,39/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV1_2(W(1,23),W(1,7),GC_11,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL FFV1_2(W(1,23),W(1,8),GC_11,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL FFV1P1N_1(W(1,11), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/40,41/),
     ...
     & TMP, W, AMP(1,9))  !  count 1
      CALL VVV1P0_1(W(1,7),W(1,15),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,7),W(1,16),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL VVV1P0_1(W(1,8),W(1,15),GC_10,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL VVV1P0_1(W(1,8),W(1,16),GC_10,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,11), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,4,1,3/), 
     & (/42,43,44,45/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV1_1(W(1,14),W(1,7),GC_11,ZERO,FK_ZERO,W(1,46))  !  count 2
      CALL FFV1_1(W(1,14),W(1,8),GC_11,ZERO,FK_ZERO,W(1,47))  !  count 2
      CALL FFV1P1N_2(W(1,1), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/46,47/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        TMP_JAMP(5) = AMP( K,10) +  AMP( K,12)   !  used 2 times
        ...
        TMP_JAMP(7) = TMP_JAMP(3) +  AMP( K,11)   !  used 2 times
        TMP_JAMP(6) = TMP_JAMP(2) +  AMP( K,9)   !  used 2 times
     ...
     $  P_JAMP(6)
        JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(1)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(4)
        JAMP(3,1) = (-1.666666666666667D-01)*TMP_JAMP(6)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(7)
        JAMP(4,1) = (5.000000000000000D-01)*TMP_JAMP(4) +((0.00000000000
