...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV1_2(W(1,6),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,2),W(1,12),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,12),W(1,2),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,3),W(1,1),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,2),W(1,13),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,6),W(1,8),W(1,13),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,10),W(1,1),GC_11,AMP(16))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,3),W(1,11),GC_11,AMP(17))
      CALL VVV1P0_1(W(1,4),W(1,11),GC_10,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,7),W(1,3),W(1,13),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,1),W(1,2),W(1,9),GC_11,AMP(19))
      CALL VVV1P0_1(W(1,4),W(1,9),GC_10,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,2),W(1,1),GC_11,AMP(20))
      CALL FFV1_1(W(1,8),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,8),W(1,1),GC_11,AMP(22))
      CALL FFV1_1(W(1,10),W(1,4),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,6),W(1,1),W(1,11),GC_11,AMP(23))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(9) = AMP(6) +  AMP(8)  ! used 2 times
      TMP_JAMP(8) = AMP(5) +  AMP(7)  ! used 2 times
      TMP_JAMP(7) = AMP(2) +  AMP(3)  ! used 2 times
      TMP_JAMP(6) = AMP(1) +  AMP(4)  ! used 2 times
      TMP_JAMP(5) = AMP(20) +  AMP(22)  ! used 2 times
      TMP_JAMP(4) = AMP(14) +  AMP(15)  ! used 2 times
      TMP_JAMP(3) = AMP(13) +  AMP(16)  ! used 2 times
      TMP_JAMP(2) = AMP(10) +  AMP(12)  ! used 2 times
      TMP_JAMP(1) = AMP(9) +  AMP(11)  ! used 2 times
      TMP_JAMP(14) = TMP_JAMP(9) +  AMP(21)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(7) +  AMP(17)  ! used 2 times
      TMP_JAMP(12) = TMP_JAMP(6) +  AMP(19)  ! used 2 times
      TMP_JAMP(11) = TMP_JAMP(2) +  AMP(23)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*TMP_JAMP(1)
     ...
     $ *TMP_JAMP(12)+(1.666666666666667D-01)*TMP_JAMP(13)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(1)+(
