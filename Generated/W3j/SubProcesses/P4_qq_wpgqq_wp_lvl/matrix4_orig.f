...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,6),W(1,11),GC_11,AMP(3))
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,7),W(1,6),W(1,13),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,12),W(1,9),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,10),W(1,13),GC_11,AMP(7))
      CALL FFV2_1(W(1,12),W(1,5),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,13),W(1,9),GC_11,AMP(8))
      CALL FFV1_1(W(1,6),W(1,4),GC_11,ZERO, FK_ZERO,W(1,13))
      CALL FFV1P0_3(W(1,2),W(1,13),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,13),W(1,11),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,1),W(1,8),W(1,12),GC_11,AMP(11))
      CALL FFV2_1(W(1,13),W(1,5),GC_100,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,12),W(1,11),GC_11,AMP(12))
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,6),W(1,2),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,12),W(1,6),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,3),W(1,13),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,1),W(1,8),W(1,13),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,1),W(1,10),W(1,2),GC_11,AMP(16))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,6),W(1,11),GC_11,AMP(17))
      CALL VVV1P0_1(W(1,4),W(1,11),GC_10,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,7),W(1,6),W(1,13),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,3),W(1,9),GC_11,AMP(19))
      CALL VVV1P0_1(W(1,4),W(1,9),GC_10,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,3),W(1,2),GC_11,AMP(20))
      CALL FFV1_1(W(1,8),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,1),W(1,8),W(1,2),GC_11,AMP(22))
      CALL FFV1_1(W(1,10),W(1,4),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,1),W(1,2),W(1,11),GC_11,AMP(23))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(7) = AMP(10) +  AMP(12)  ! used 2 times
      TMP_JAMP(6) = AMP(9) +  AMP(11)  ! used 2 times
      ...
      TMP_JAMP(14) = TMP_JAMP(7) +  AMP(23)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(4) +  AMP(17)  ! used 2 times
      TMP_JAMP(12) = TMP_JAMP(3) +  AMP(19)  ! used 2 times
     ...
     $ -1.666666666666667D-01)*TMP_JAMP(8)+(-5.000000000000000D-01)
     $ *TMP_JAMP(9)+(-5.000000000000000D-01)*TMP_JAMP(11)
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(8)+(1.666666666666667D-01)
     $ *TMP_JAMP(9)+((0.000000000000000D+00,-5.000000000000000D-01))
