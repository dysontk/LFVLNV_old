...
C     
C     Process: u c~ > w+ g d c~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: u s~ > w+ g d s~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: c u~ > w+ g s u~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     Process: c d~ > w+ g s d~ WEIGHTED<=5 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV1P0_3(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 14
      CALL FFV1P0_3(W(1,11),W(1,3),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 14
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 1
      CALL FFV1_1(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 1
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 1
      CALL FFV1_1(W(1,3),W(1,8),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,23))  !  count 18
      CALL FFV1P0_3(W(1,10),W(1,19),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV1P0_3(W(1,10),W(1,20),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,21),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,11),W(1,22),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 3
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 3
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 1
      CALL FFV1_2(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 1
      CALL FFV1_2(W(1,11),W(1,7),GC_11,ZERO,FK_ZERO,W(1,34))  !  count 1
      CALL FFV1_2(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,35))  !  count 1
      CALL FFV1P0_3(W(1,32),W(1,2),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 2
      CALL FFV1P0_3(W(1,33),W(1,2),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV1P0_3(W(1,34),W(1,3),GC_11,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV1P0_3(W(1,35),W(1,3),GC_11,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_3(W(1,23), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,3,2,1/), 
     & (/36,37,38,39/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  P_JAMP(3)+(5.000000000000000D-01)*TMP_JAMP(5) +(5.000000000000000D-01)*T
     $  MP_JAMP(6)
        JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(6)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(7)
        JAMP(3,1) = ((0.000000000000000D+00,5.000000000000000D-01)) *TMP
     $  _JAMP(3)+(5.000000000000000D-01)*TMP_JAMP(4) +(5.000000000000000D-01)*TM
     $  P_JAMP(7)
        JAMP(4,1) = (-1.666666666666667D-01)*TMP_JAMP(4)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(5)
