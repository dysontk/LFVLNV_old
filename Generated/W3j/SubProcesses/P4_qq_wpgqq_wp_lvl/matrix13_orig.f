...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,6),W(1,1),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV2_2(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,1),W(1,2),W(1,12),GC_11,AMP(14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(14) = TMP_JAMP(7) +  AMP(17)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(4) +  AMP(22)  ! used 2 times
     ...
     $ *TMP_JAMP(9)+(-5.000000000000000D-01)*TMP_JAMP(13)
