...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV1P0_3(W(1,12),W(1,1),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,13),W(1,1),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P0_3(W(1,14),W(1,2),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV1P0_3(W(1,15),W(1,2),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 2
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,1),W(1,7),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV1_1(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 1
     ...
     & TMP, W, AMP(1,4))  !  count 1
      ...
      CALL FFV1P0_3(W(1,9),W(1,1),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 14
      CALL FFV1P0_3(W(1,10),W(1,2),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 14
