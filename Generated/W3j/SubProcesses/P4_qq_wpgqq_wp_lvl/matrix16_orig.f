...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,1),W(1,9),GC_11,AMP(2))
      CALL FFV1_1(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(7) = TMP_JAMP(5) +  AMP(11)  ! used 2 times
      TMP_JAMP(6) = TMP_JAMP(4) +  AMP(9)  ! used 2 times
