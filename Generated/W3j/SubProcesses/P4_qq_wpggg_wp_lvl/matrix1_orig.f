...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ ,1.000000000000000D+00)) * TMP_JAMP(12)  ! used 2 times
      JAMP(1,1) = AMP(21)+AMP(23)+AMP(24)+AMP(45)+(-1.000000000000000D
     $ +00)*TMP_JAMP(24)+TMP_JAMP(26)
      JAMP(2,1) = AMP(19)+AMP(20)+AMP(22)+AMP(42)+TMP_JAMP(23)
     $ +TMP_JAMP(24)
      JAMP(3,1) = AMP(37)+AMP(39)+AMP(40)+AMP(46)+(-1.000000000000000D
     $ +00)*TMP_JAMP(22)+(-1.000000000000000D+00)*TMP_JAMP(26)
      JAMP(4,1) = AMP(27)+AMP(28)+AMP(30)+AMP(38)+TMP_JAMP(22)
     $ +TMP_JAMP(25)
      JAMP(5,1) = AMP(41)+AMP(43)+AMP(44)+AMP(48)+(-1.000000000000000D
     $ +00)*TMP_JAMP(23)+(-1.000000000000000D+00)*TMP_JAMP(27)
      JAMP(6,1) = AMP(29)+AMP(31)+AMP(32)+AMP(47)+(-1.000000000000000D
     $ +00)*TMP_JAMP(25)+TMP_JAMP(27)
