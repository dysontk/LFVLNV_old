...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,10),W(1,11),GC_11,AMP(2))
      CALL FFV2_2(W(1,6),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,2),W(1,11),GC_11,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,1),W(1,9),GC_11,AMP(4))
      CALL FFV1_1(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,3),W(1,9),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,10),W(1,12),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,2),W(1,12),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,2),W(1,13),GC_11,AMP(19))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,13),W(1,2),W(1,9),GC_11,AMP(20))
      CALL VVV1P0_1(W(1,4),W(1,11),GC_10,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,6),W(1,8),W(1,9),GC_11,AMP(21))
      CALL FFV1_1(W(1,8),W(1,4),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,2),W(1,11),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,7),W(1,1),W(1,9),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,13),W(1,1),W(1,11),GC_11,AMP(24))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(14) = TMP_JAMP(8) +  AMP(22)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(4) +  AMP(24)  ! used 2 times
      TMP_JAMP(12) = TMP_JAMP(3) +  AMP(20)  ! used 2 times
     ...
     $ +(1.666666666666667D-01)*TMP_JAMP(6)+(5.000000000000000D-01)
     $ *TMP_JAMP(7)+(5.000000000000000D-01)*TMP_JAMP(11)
      JAMP(3,1) = ((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(5)+(5.000000000000000D-01)*TMP_JAMP(9)
     $ +(5.000000000000000D-01)*TMP_JAMP(12)+(1.666666666666667D-01)
     $ *TMP_JAMP(13)+(1.666666666666667D-01)*TMP_JAMP(14)
      JAMP(4,1) = (-5.000000000000000D-01)*TMP_JAMP(6)+(
     $ -1.666666666666667D-01)*TMP_JAMP(7)+(-1.666666666666667D-01)
