...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,1),W(1,6),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV2_1(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,13),W(1,12),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,2),W(1,13),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(9))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,8),W(1,14),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,1),W(1,8),W(1,9),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,11),W(1,3),W(1,14),GC_11,AMP(12))
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,14))
      CALL FFV1P0_3(W(1,14),W(1,6),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(13))
      CALL FFV2_2(W(1,14),W(1,5),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,3),W(1,12),GC_11,AMP(14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,9),W(1,3),W(1,10),GC_11,AMP(17))
      CALL VVV1P0_1(W(1,4),W(1,10),GC_10,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,14),W(1,12),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,11),W(1,3),W(1,7),GC_11,AMP(21))
      CALL FFV1_2(W(1,11),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_11,AMP(22))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(2) = AMP(6) +  AMP(7)  ! used 2 times
      TMP_JAMP(1) = AMP(5) +  AMP(8)  ! used 2 times
