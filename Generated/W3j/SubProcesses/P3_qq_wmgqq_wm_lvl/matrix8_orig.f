...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,10),W(1,11),GC_11,AMP(2))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,10),W(1,13),GC_11,AMP(17))
      CALL FFV1_1(W(1,10),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,1),W(1,12),W(1,9),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,1),W(1,8),W(1,9),GC_11,AMP(21))
      CALL FFV1_1(W(1,8),W(1,4),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,1),W(1,3),W(1,11),GC_11,AMP(22))
