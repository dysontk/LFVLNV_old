...
C     
C     Process: u u~ > w- g c s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: c c~ > w- g u d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: d d~ > w- g c s~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: s s~ > w- g u d~ WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,9))  !  count 10
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,10))  !  count 23
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,11))  !  count 23
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_2(W(1,2),W(1,9),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV2_1(W(1,10),W(1,7),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 18
      CALL FFV1P0_3(W(1,12),W(1,4),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,13),W(1,4),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P0_3(W(1,14),W(1,3),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 2
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV1_1(W(1,3),W(1,9),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 1
      CALL FFV1_1(W(1,4),W(1,8),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 1
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,24),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,25),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,22),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,23),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/26,27,28,29/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 3
      CALL FFV1_1(W(1,10),W(1,9),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 3
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 14
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 14
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 3
      CALL FFV1_2(W(1,11),W(1,9),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 3
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL VVV1P0_1(W(1,8),W(1,32),GC_10,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL VVV1P0_1(W(1,8),W(1,33),GC_10,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL VVV1P0_1(W(1,9),W(1,32),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,9),W(1,33),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P1N_3(W(1,11), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,4,1,3/), 
     & (/40,41,42,43/),
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV1_1(W(1,16),W(1,8),GC_11,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL FFV1_1(W(1,16),W(1,9),GC_11,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_2(W(1,11), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/44,45/),
     ...
     & TMP, W, AMP(1,11))  !  count 1
      CALL FFV1_2(W(1,21),W(1,8),GC_11,ZERO,FK_ZERO,W(1,46))  !  count 2
      CALL FFV1_2(W(1,21),W(1,9),GC_11,ZERO,FK_ZERO,W(1,47))  !  count 2
      CALL FFV1P1N_1(W(1,10), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/46,47/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        TMP_JAMP(5) = AMP( K,9) +  AMP( K,11)   !  used 2 times
        TMP_JAMP(4) = AMP( K,7) +  AMP( K,8)   !  used 2 times
        TMP_JAMP(3) = AMP( K,3) +  AMP( K,4)   !  used 2 times
        TMP_JAMP(2) = AMP( K,1) +  AMP( K,2)   !  used 2 times
        TMP_JAMP(1) = AMP( K,5) +  AMP( K,6)   !  used 2 times
        TMP_JAMP(7) = TMP_JAMP(4) +  AMP( K,12)   !  used 2 times
        TMP_JAMP(6) = TMP_JAMP(1) +  AMP( K,10)   !  used 2 times
     ...
     $  MP_JAMP(6)
        JAMP(3,1) = (-1.666666666666667D-01)*TMP_JAMP(2)+( -1.6666666666
     $  66667D-01)*TMP_JAMP(3)
        JAMP(4,1) = (5.000000000000000D-01)*TMP_JAMP(3) +((0.00000000000
