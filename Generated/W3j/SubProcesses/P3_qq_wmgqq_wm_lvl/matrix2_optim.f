...
C     
C     Process: u s > w- g u c WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: c d > w- g c u WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     Process: d s > w- g d c WEIGHTED<=5 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,3))  !  count 23
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,4))  !  count 1
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,5))  !  count 1
      CALL FFV2_3(W(1,5),W(1,4),GC_100,MDL_MW,FK_MDL_WW,W(1,6))  !  count 6
      ...
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_2(W(1,2),W(1,7),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV2_1(W(1,11),W(1,6),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 18
      CALL FFV1P0_3(W(1,12),W(1,9),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_2(W(1,3),W(1,6),GC_100,ZERO,FK_ZERO,W(1,21))  !  count 18
      CALL FFV1P1N_3(W(1,21), W(1,11), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 1
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 1
      CALL FFV1_1(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 1
      CALL FFV1_1(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,25))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,22),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,23),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,24),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,25),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/26,27,28,29/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV1_1(W(1,11),W(1,7),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 3
      CALL FFV1_1(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 3
      CALL FFV1P0_3(W(1,1),W(1,9),GC_11,ZERO,FK_ZERO,W(1,32))  !  count 14
      CALL FFV1P0_3(W(1,2),W(1,10),GC_11,ZERO,FK_ZERO,W(1,33))  !  count 14
      CALL FFV2_1(W(1,30),W(1,6),GC_100,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2_1(W(1,31),W(1,6),GC_100,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV1P1N_2(W(1,3), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/34,35/),
     & TMP, W, AMP(1,5))
      CALL FFV1P1N_2(W(1,3), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/34,35/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1_2(W(1,3),W(1,7),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 3
      CALL FFV1_2(W(1,3),W(1,8),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 3
      CALL FFV2_2(W(1,36),W(1,6),GC_100,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV2_2(W(1,37),W(1,6),GC_100,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_1(W(1,11), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/38,39/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,11), W(1,33), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/38,39/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL VVV1P0_1(W(1,7),W(1,32),GC_10,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL VVV1P0_1(W(1,7),W(1,33),GC_10,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL VVV1P0_1(W(1,8),W(1,32),GC_10,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL VVV1P0_1(W(1,8),W(1,33),GC_10,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,16), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,4,1,3/), 
     & (/40,41,42,43/),
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV1_1(W(1,16),W(1,7),GC_11,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL FFV1_1(W(1,16),W(1,8),GC_11,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_2(W(1,3), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/44,45/),
     ...
     & TMP, W, AMP(1,11))  !  count 1
      CALL FFV1_2(W(1,21),W(1,7),GC_11,ZERO,FK_ZERO,W(1,46))  !  count 2
      CALL FFV1_2(W(1,21),W(1,8),GC_11,ZERO,FK_ZERO,W(1,47))  !  count 2
      CALL FFV1P1N_1(W(1,11), W(1,32), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/46,47/),
