...
C     
C     Process: d s > w- g u s WEIGHTED<=5 @3
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,7),ZERO,+1,+1*IC(7),W(1,10))  !  count 5
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,11))  !  count 5
      ...
      CALL FFV1P0_3(W(1,2),W(1,10),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 14
      CALL FFV1P0_3(W(1,3),W(1,11),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 14
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 3
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,20))  !  count 3
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,21))  !  count 18
      CALL FFV1P1N_2(W(1,21), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_2(W(1,21), W(1,16), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/19,20/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_1(W(1,19),W(1,6),GC_100,ZERO,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_1(W(1,20),W(1,6),GC_100,ZERO,FK_ZERO,W(1,23))  !  count 2
     ...
     & TMP, W, AMP(1,4))  !  count 1
      ...
      CALL FFV1_1(W(1,11),W(1,7),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 1
      CALL FFV1_1(W(1,11),W(1,8),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,24),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,25),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,26),GC_11,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,27),GC_11,ZERO,FK_ZERO,W(1,31))  !  count 2
      CALL FFV1P1N_3(W(1,21), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/28,29,30,31/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      ...
      CALL FFV1P0_3(W(1,32),W(1,10),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 2
      CALL FFV1P0_3(W(1,33),W(1,10),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV1P0_3(W(1,34),W(1,11),GC_11,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV1P0_3(W(1,35),W(1,11),GC_11,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV1P1N_3(W(1,21), W(1,9), GC_11, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/36,37,38,39/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV1_2(W(1,21),W(1,7),GC_11,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL FFV1_2(W(1,21),W(1,8),GC_11,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL FFV1P1N_1(W(1,9), W(1,15), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/40,41/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        ...
        JAMP(1,1) = (-1.666666666666667D-01)*TMP_JAMP(6)+( -1.6666666666
